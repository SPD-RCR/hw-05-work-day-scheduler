...
- Top header lists current date

- Write the layout in HTML with DIVs.
- Fill in the hours and the Save icons for each row.
  NOTE: If this was for more than a single day example: Use grid for the day planner layout
  - each hour is a Row
